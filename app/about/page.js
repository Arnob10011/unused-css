            ...
            <div class='glass_effect rounded-2xl mx-auto py-6 sm:py-8 lg:py-12'>
              <div class='mx-auto max-w-screen-md px-4 md:px-8'>
                ...
                <p class='mb-6 text-slate-600 sm:text-lg md:mb-8 leading-7'>
                  Welcome to my website, which is an unique free tool in the
                  ...
                  in any other framework . I am an
                  enthusiastic developer who enjoy building awesome and helpful
                  online tools for everyone. I believe that the internet should
                  be a place where you can do anything you want with ease and
                  convenience.
                  <br />
                  <br />
                  That’s why I am always working hard to bring you new and
                  improved tools that can meet your needs and expectations. I
                  appreciate your support and feedback, so please feel free to
                  reach out to me anytime. I am always happy to hear from you
                  and assist you with any issues or questions you may have.
                  Thank you for choosing me for making your website faster. I
