              ...
              <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-10'>
                <div>
                  <div className='glass_effect rounded-2xl p-7'>
                    ...
                    Upload your folder or file. The folder or file must contain css file
                    along with html or javascript 
                      file or both. 
                    </p>
                ...
                <div className='glass_effect rounded-2xl p-7'>
                  ...
                  <p className='text-sm mb-3 text-slate-700'>
                    You can copy and paste your html, css and js code .Or you can 
                    paste ( html and css ) or (js or css)
                  </p>
                  <Form />
                </div>
              </div>
